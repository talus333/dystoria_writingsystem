...
**App version:** v.657 (internal `APP_VERSION` still `2026.07.20.624`) · **Updated:** 2026-09-07 · _md5 `8c651b39ac1d010454b69a744972eaa0`, **written to the repo folder and verified on device**. `worker.js` md5 `c2161c9674113095942e7a27a81645d8`, unchanged._
