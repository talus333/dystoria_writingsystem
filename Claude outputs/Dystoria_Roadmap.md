...
**App version:** v.669 (internal `APP_VERSION` still `2026.07.20.624`) · **Updated:** 2026-09-09 · _md5 `d45c8f3193ac1497800cc6a7b409a200`, **written to the repo folder and verified on device**. `worker.js` md5 `c2161c9674113095942e7a27a81645d8`, unchanged._
