...
**App version:** v.668 (internal `APP_VERSION` still `2026.07.20.624`) · **Updated:** 2026-09-09 · _md5 `60bc662546efb44b9ab4829a38d828e6`, **written to the repo folder and verified on device**. `worker.js` md5 `c2161c9674113095942e7a27a81645d8`, unchanged._
...
| 47 | **Conflict axes** — derived rather than typed. **Phases 1–3 ✓ v.668** (the driver — story-level, optional; the Conflict row's sentence naming the things; the strip in Plan under the row, collapsed, ⚔ bonds as a lighter mark; the three findings in Checks) [four rulings, Jeremy 2026-09-09]. **Left, optional (phase 4):** colour on the grid's stake columns, a Bonds *Opposition* lens, a per-Part driver, conflict-first authoring (+ stake with the axis pre-filled) | ◐ |
