...
**App version:** v.681 (internal `APP_VERSION` still `2026.07.20.624`) · **Updated:** 2026-09-13 · _md5 `cf62bbc945a5cee507450e5cfd225bf9`, **written to the repo folder and verified on device**. `worker.js` md5 `c2161c9674113095942e7a27a81645d8`, unchanged._
