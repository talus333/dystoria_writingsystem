...
**App version:** v.667 (internal `APP_VERSION` still `2026.07.20.624`) · **Updated:** 2026-09-09 · _md5 `7b9b34ed36121c0a2fa48d2c77638739`, **written to the repo folder and verified on device**. `worker.js` md5 `c2161c9674113095942e7a27a81645d8`, unchanged._
...
| 47 | **Conflict axes** — derived rather than typed. **Unblocked by v.667** (an axis is only ever `stakeData.axis` now), and cheaper than its doc assumes | ☐ |
