...
**App version:** v.673 (internal `APP_VERSION` still `2026.07.20.624`) · **Updated:** 2026-09-12 · _md5 `53baafa54506608c40c1b1b083ac1182`, **written to the repo folder and verified on device**. `worker.js` md5 `c2161c9674113095942e7a27a81645d8`, unchanged._
