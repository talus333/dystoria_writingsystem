...
**App version:** v.672 (internal `APP_VERSION` still `2026.07.20.624`) · **Updated:** 2026-09-11 · _md5 `1577e6109b50fb170d25e6d40c89e982`, **written to the repo folder and verified on device**. `worker.js` md5 `c2161c9674113095942e7a27a81645d8`, unchanged._
