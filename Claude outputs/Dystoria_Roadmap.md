...
**App version:** v.677 (internal `APP_VERSION` still `2026.07.20.624`) · **Updated:** 2026-09-12 · _md5 `249d4bd104f295c58ac581768f66108e`, **written to the repo folder and verified on device**. `worker.js` md5 `c2161c9674113095942e7a27a81645d8`, unchanged._
