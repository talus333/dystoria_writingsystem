...
**App version:** v.666 (internal `APP_VERSION` still `2026.07.20.624`) · **Updated:** 2026-09-08 · _md5 `88381ff619c8fa2f995a00cf3d2e31a6`, **written to the repo folder and verified on device**. `worker.js` md5 `c2161c9674113095942e7a27a81645d8`, unchanged._
