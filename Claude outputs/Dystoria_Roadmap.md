...
**App version:** v.647 (internal `APP_VERSION` still `2026.07.20.624`) · **Updated:** 2026-09-07 · _md5 `26f85c0693ec1399cb8485d739a6b54d`, **written to the repo folder and verified on device**. `worker.js` md5 `c2161c9674113095942e7a27a81645d8`, unchanged._
